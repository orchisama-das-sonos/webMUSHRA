...
function PairedComparisonPage2(_reference, _condition, _condition2, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
...
PairedComparisonPage2.prototype.getName = function () {
  return this.pageConfig.name;
};

PairedComparisonPage2.prototype.init = function () {
...
PairedComparisonPage2.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
...
PairedComparisonPage2.prototype.setLoopStart = function() {
...
PairedComparisonPage2.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider');
...
PairedComparisonPage2.prototype.pause = function() {
    this.mushraAudioControl.pause();
};

PairedComparisonPage2.prototype.cleanButtons = function() {
...
PairedComparisonPage2.prototype.btnCallbackReference = function() {
...
PairedComparisonPage2.prototype.btnCallbackA = function() {
	this.currentItem = "A";
...
PairedComparisonPage2.prototype.btnCallbackB = function() {
	this.currentItem = "B";
...
PairedComparisonPage2.prototype.load = function () {
...
PairedComparisonPage2.prototype.save = function () {
  this.macic.unbind();
...
PairedComparisonPage2.prototype.store = function () {
