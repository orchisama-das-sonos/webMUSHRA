...
function PairedComparisonNoReferencePage(_reference, _condition, _condition2, _pageManager, _pageTemplateRenderer, _audioContext, _bufferSize, _audioFileLoader, _session, _pageConfig, _errorHandler, _language) {
...
PairedComparisonNoReferencePage.prototype.getName = function () {
  return this.pageConfig.name;
};

PairedComparisonNoReferencePage.prototype.init = function () {


  this.mushraAudioControl = new MushraAudioControl(this.audioContext, this.bufferSize, this.condition2, [this.condition], this.errorHandler, false, false, true);
...
PairedComparisonNoReferencePage.prototype.render = function (_parent) {
  var div = $("<div></div>");
  _parent.append(div);
  ...
  var trQuestion = $("<tr><td  colspan='3'><br/><br/>" + this.pageManager.getLocalizer().getFragment(this.language, 'quest_generic') + "</td></tr>");
...
PairedComparisonNoReferencePage.prototype.setLoopStart = function() {
...
PairedComparisonNoReferencePage.prototype.setLoopEnd = function() {
  var slider = document.getElementById('slider');
...
PairedComparisonNoReferencePage.prototype.pause = function() {
    this.mushraAudioControl.pause();
};

PairedComparisonNoReferencePage.prototype.cleanButtons = function() {
...
PairedComparisonNoReferencePage.prototype.btnCallbackReference = function() {
...
PairedComparisonNoReferencePage.prototype.btnCallbackA = function() {
	this.currentItem = "A";
...
PairedComparisonNoReferencePage.prototype.btnCallbackB = function() {
	this.currentItem = "B";
...
PairedComparisonNoReferencePage.prototype.load = function () {
...
PairedComparisonNoReferencePage.prototype.save = function () {
  this.macic.unbind();
...
PairedComparisonNoReferencePage.prototype.store = function () {
  ...
  choice.reference = this.condition.getId();
  choice.nonReference = this.condition2.getId();
  ...
  if (this.choice == "a") {
    choice.answer = this.condition.getId();
  } else if (this.choice == "b") {
    choice.answer = this.condition2.getId();
